...
public class NuovoProdotto extends JFrame implements MouseListener
{
    ...
    NuovoProdotto()
    {
        ...
        categoriaf.setFocusable(true);

        prezzo.setBounds(50,171,100,30);
        ...
        minortitle.setText("NUOVO PRODOTTO");
    ...
    {
        title.setText("AGGIUNGI PRODOTTO");
    ...
    public void mousePressed(MouseEvent e)
    {
        ...
        if(e.getSource() == conferma)
        {
            ...
            try
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Campi inseriti non validi", "Product Management", JOptionPane.PLAIN_MESSAGE);
                }
                else
                {
                    ...
                    while ((line = reader.readLine()) != null)
                    {
                        ...
                        if (array[0].equals(nomef.getText()) && array[1].equals(categoriaf.getText())) trovatoprodotto = true;
                    }
                    if (trovatoprodotto)
                    {
                        JOptionPane.showMessageDialog(null, "Prodotto già esistente", "Product Management", JOptionPane.PLAIN_MESSAGE);
                    }
                    else
                    {
                        JOptionPane.showMessageDialog(null, "Prodotto aggiunto correttamente", "Product Management", JOptionPane.PLAIN_MESSAGE);

                        FileWriter writer = new FileWriter("Prodotti.txt", true);
                        writer.write(nomef.getText().toUpperCase() + "," + categoriaf.getText().toUpperCase() + "," + prezzof.getText().toUpperCase() + "," + GestioneMagazzino.numeroprodotti() + "\n");
                        writer.close();
